...
The initial five records are pending manual verification and come from FTC, CFPB, and CMS pages. They are source candidates, not findings or statistics. The current verified record count is zero.
